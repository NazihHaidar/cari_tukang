    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                <a class="active-menu" href="empty.php"><i class="fa fa-fw fa-table"></i> Tabel Claim</a>
                </li>
                    <li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        ...
                                        <td><?php echo $date1 = $row['tgl_mulai'];?></td>
                                        <td><?php echo $date2 = $row['tgl_berakir'];?></td>
                                        <td><?php echo $row['promo'];?></td>
                                        <td><?php echo $row['barang'];?></td>
                                        <td><?php echo $row['mekanisme'];?></td>
                                        <td><?php echo $row['jml_barang'];?></td>
                                        <td><?php echo $row['jml_rupiah'];?></td>
                                        <td><?php echo $row['activity'];?></td>
                                        <td><?php echo $row['implementasi'];?></td>
                                        <td><?php echo $row['keterangan'];?></td>
                                        <td><?php if(strtotime(date("Y-m-d")) <= strtotime($date2)) echo "Active"; else { echo "Expired";} ?></td>
                                        <td><?php echo $row['waktu'];?></td>	
                                        <td><a href="edit.php?id=<?php echo $row['id']; ?>">Update</a>
